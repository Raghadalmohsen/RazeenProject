...
class FrameNinetynineScreen extends StatelessWidget {
  FrameNinetynineScreen({Key? key})
      : super(
          key: key,
        );
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8.v),
                _buildStackWithViewScreenshotAndText(context),
                      ...
                      Container(
                        ...
                        child: Stack(
                          ...
                          children: [
                            ...
                            CustomImageView(
                              imagePath: ImageConstant.imgImage4493x83,
                              height: 93.v,
                              width: 83.h,
                              alignment: Alignment.bottomRight,
                            ),
                            ...
                            Align(
                              ...
                              child: Container(
                                ...
                                child: Text(
                                  ...
                                  style:
                                      CustomTextStyles.headlineSmallBluegray700,
                                ),
                              ),
                            ),
                          ],
        ...
        bottomNavigationBar: _buildBottomAppBarWithImageFabAndImage(context),
  ...
  /// Section Widget
  Widget _buildStackWithViewScreenshotAndText(BuildContext context) {
    return SizedBox(
      height: 141.v,
      width: 353.h,
      child: Stack(
  ...
  /// Section Widget
  Widget _buildBottomAppBarWithImageFabAndImage(BuildContext context) {
