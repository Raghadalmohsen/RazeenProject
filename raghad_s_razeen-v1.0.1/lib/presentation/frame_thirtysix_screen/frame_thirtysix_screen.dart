...
class FrameThirtysixScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
        ...
        bottomNavigationBar: _buildBottomAppBarWithImageFabAndMedal(context),
  ...
  /// Section Widget
  Widget _buildBottomAppBarWithImageFabAndMedal(BuildContext context) {
