...
class FrameThirtytwoScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return SafeArea(
      child: Scaffold(
          ...
          child: Container(
            ...
            child: Column(
              ...
              children: [
                ...
                SizedBox(height: 8.v),
                _buildStackWithViewScreenshotWidgetImage(context),
        ...
        bottomNavigationBar: _buildBottomAppBarWithImageFabMedal(context),
  ...
  /// Section Widget
  Widget _buildStackWithViewScreenshotWidgetImage(BuildContext context) {
    return SizedBox(
      height: 141.v,
      width: 353.h,
      child: Stack(
  ...
  /// Section Widget
  Widget _buildBottomAppBarWithImageFabMedal(BuildContext context) {
